...
| P1-2 | ✅ Done | Added `tests/test_bitalino_streaming.py` (8 tests; `stream_bitalino` 0%→59%) and `tests/test_recorder_unit.py` (5 tests; `stream_recorder` 11%→26%). Unit TOTAL 21%→**25%**; full suite **125 passed, 7 skipped, EXIT 0**. |
